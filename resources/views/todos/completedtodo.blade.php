...
@section('title', 'Todos')
    ...
    <div class="row justify-content-center">
     <div class="col-md-8">
        <div class=" my-5 card ">
                 @include('layouts.msg')
    <div class=" card-header "> <h4 class="text-center m-0 p-0"><b><ins>Completed Todos</ins></b></h4>
        <p>    <a href="/todos/create" class="text-link btn-sm ">Add new Todos</a> <br>
<a href="/todos" class="text-link btn-sm ">Show all Todos</a>
      </p>
...
<div class="my-5">
    <div class="jumbotron text-center m-0 p-5">
        <h4 class="text-danger">No completed Todos !</h4>
        <a href="/todos" class="btn btn-warning">Show all Todos</a>
